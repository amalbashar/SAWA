...
@section('title', 'Create Care Provider')
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3>Create Care Provider</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.care_providers.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="clinic_address" id="clinic_address" class="form-control" value="{{ old('clinic_address') }}" required>
